...
import com.iucyh.cheesevol.common.response.envelope.SuccessResponse;
 ...
 * <p><b>제외</b>: 이미 {@link SuccessResponse}로 래핑된 응답, {@link FailResponse} (전역 예외 핸들러를 통해 생성됨), 기타 JSON 본문이 아닌 것들 ({@code CharSequence}, {@code byte[]}, {@code Resource})</p>
 */
