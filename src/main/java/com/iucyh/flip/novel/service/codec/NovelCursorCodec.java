package com.iucyh.flip.novel.service.codec;

import com.iucyh.flip.novel.exception.InvalidNovelCursor;
...
public interface NovelCursorCodec {
     ...
     * @throws InvalidNovelCursor 전달된 {@code cursor}가 유효한 값이 아닐 때
     */
