package com.iucyh.flip.novel.service.registry;
...
/**
 * <p>Novel의 페이징 전략을 조회하는 Registry</p>
 * <b>빈 생성 시 특정 NovelSortType과 매칭되는 전략이 없으면 {@code IllegalStateException} 발생</b>
 */
@Component
public class NovelPagingStrategyRegistry {

    private final Map<NovelSortType, NovelPagingStrategy> pagingStrategyMap;

    public NovelPagingStrategyRegistry(List<NovelPagingStrategy> pagingStrategies) {
